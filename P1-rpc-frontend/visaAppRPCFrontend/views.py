...
from visaAppRPCFrontend.forms import PagoForm, TarjetaForm, DelPagoForm, GetPagosForm
from visaAppRPCFrontend.pagoDB import (verificar_tarjeta, registrar_pago,
